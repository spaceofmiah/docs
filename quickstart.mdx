...
```
<Warning>
Disconnecting an interaction allows you continue the conversation at a later date simply
by passing same `session_id` into the SDK again. To permanently terminate your session, see [Terminate Session](https://docs.diarupt.ai/api-reference/session/post-terminate-session)
</Warning>
